...
import VideoSearchGuide from './components/VideoSearchGuide';
import VideoSearchDiagnostic from './components/VideoSearchDiagnostic';
            ...
            <div className="flex overflow-hidden w-full h-full relative z-0">
              ...
              <div className="grow h-full overflow-hidden">
                <Routes>
                  ...
                  <Route path="/video-search-guide" element={<VideoSearchGuide/>}/>
                  <Route path="/video-search-diagnostic" element={<VideoSearchDiagnostic/>}/>
