...
import {Cog8ToothIcon, PlusIcon, Squares2X2Icon, ChartBarIcon} from "@heroicons/react/24/outline";
            ...
            <div className="scrollbar-trigger relative h-full flex-1 items-start border-white/20">
              ...
              <nav className="flex h-full flex-col p-2" aria-label="Chat history">
                ...
                <div className="border-t border-white/20 mt-2 pt-2">
                  <Link to="/explore" className="flex items-center m-2 dark:bg-gray-900 dark:text-gray-100 text-gray-900 hover:bg-gray-500/10 rounded-md px-2 py-2">
                    <Squares2X2Icon {...iconProps} className="mr-2"/>
                    <span>{t('custom-chats-header')}</span>
                  </Link>
                  
                  <Link to="/admin" className="flex items-center m-2 dark:bg-gray-900 dark:text-gray-100 text-gray-900 hover:bg-gray-500/10 rounded-md px-2 py-2">
                    <ChartBarIcon {...iconProps} className="mr-2"/>
